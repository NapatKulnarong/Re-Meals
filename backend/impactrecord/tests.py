...
class ImpactRecordTests(APITestCase):
    ...
    # 1️Test creating ImpactRecord manually (should not be allowed)
    ...
    # 2️Test auto-create ImpactRecord when food distributed
    ...
    # Test ImpactRecord created only once (True→True should NOT create again)
    ...
    # Test that impact_date is today's date on creation
    ...
    # Test meals_saved calculation correctness
    ...
    # Test weight_saved_kg calculation correctness
    ...
    # Test CO2 reduction calculation correctness
    ...
    # Test impactrecord accessible via /impact/<id>
    ...
    # Test impactrecord list returns correct count
    ...
    # Test deleting food should delete ImpactRecord (CASCADE)
